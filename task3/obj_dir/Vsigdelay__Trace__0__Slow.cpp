...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,"din", false,-1, 7,0);
    tracep->declBus(c+9,"dout", false,-1, 7,0);
    tracep->declBus(c+10,"address1", false,-1, 8,0);
    tracep->declBus(c+11,"address2", false,-1, 8,0);
    ...
    tracep->declBus(c+11,"count_offset", false,-1, 8,0);
    tracep->declBus(c+10,"counter_value", false,-1, 8,0);
    tracep->declBus(c+11,"counter_offset_value", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+10,(vlSelf->sigdelay__DOT__addrCounter__DOT__counter_value),9);
    bufp->fullSData(oldp+11,(vlSelf->sigdelay__DOT__addrCounter__DOT__counter_offset_value),9);
