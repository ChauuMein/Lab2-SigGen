...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+9,(vlSelf->sigdelay__DOT__addrCounter__DOT__counter_value),9);
    bufp->chgSData(oldp+10,(vlSelf->sigdelay__DOT__addrCounter__DOT__counter_offset_value),9);
}
